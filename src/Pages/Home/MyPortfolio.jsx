...
export default function MyPortfolio() {
  const upperRow = data.experience.slice(0, 3); // Get the first 3 experiences for the upper row
  const lowerRow = data.experience.slice(3, 5); // Get the next 2 experiences for the lower row
  return (
    <section className="portfolio--section" id="MyPortfolio">
      ...
      <div className="experience-container">
        <div className="upper-row">
          {upperRow.map((experience, index) => (
            <div key={index} className="experience-card">
              <div className="timeline">{experience.item}</div>
