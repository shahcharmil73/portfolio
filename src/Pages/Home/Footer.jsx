  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logp.png" alt="Logoipsum" width="120px"/>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100004650076240"
            ...
            <li>
              <a
                href="https://www.instagram.com/charmilshah__73/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/charmil-shah/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
